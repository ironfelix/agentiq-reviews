...
Database URL is loaded from the DATABASE_URL environment variable.
"""
...
# Import ALL models so autogenerate picks up their metadata.
# The import of app.models triggers __init__.py which imports every model.
