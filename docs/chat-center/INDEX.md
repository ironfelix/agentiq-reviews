...
8. **[SCENARIO_ENGINE.md](./SCENARIO_ENGINE.md)** — Сценарность, приоритеты P0-P3, guardrails
   - Unified слой interactions
   - Policy engine (allow/assist/deny)
   - Mermaid-схемы pipeline/state/sequence

9. **[scenario-engine.html](./scenario-engine.html)** — Та же схема и логика в “визуальном” HTML (SVG-диаграмма)
   - Одна страница, без Mermaid
   - Пояснения шагов и P3-окон
...
- **Documentation:** `docs/chat-center/`
