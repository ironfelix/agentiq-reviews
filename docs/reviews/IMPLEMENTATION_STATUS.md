...
**Location**: `scripts/wbcon-task-to-card-v2.py:48-95`
...
**Location**: `scripts/wbcon-task-to-card-v2.py:98-159`
...
**Location**: `scripts/llm_analyzer.py:701-778`
...
**Location**: `scripts/wbcon-task-to-card-v2.py:1280-1291`
...
### `llm_deep_analysis(...)`
**Location**: `scripts/llm_analyzer.py:356-470`
