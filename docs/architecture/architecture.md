...
## MVP Roadmap (актуализировано)

### Phase 1: Reviews Analytics (готово) ✓
- [x] Анализ отзывов WB
- [x] Классификация причин
- [x] Анализ качества ответов
- [x] Отчёты + PDF

### Phase 2: Chat Center MVP+ (сейчас)
- [ ] Единое окно чатов (Ozon)
- [ ] Подключение аккаунта + синхронизация чатов
- [ ] Чтение/ответы, фильтры, SLA таймеры
- [ ] Пилоты → первые оплаты

### Phase 3: Multi-market + AI Assist
- [ ] WB + Яндекс.Маркет
- [ ] AI-подсказки ответов (copilot, без автоотправки)
- [ ] Метрики качества/скорости ответа

### Phase 4: Automation & Scale
- [ ] Webhooks / realtime обновления
- [ ] Масштабирование воркеров
- [ ] Триггеры/автоответы (с модерацией)

### Phase 5: Agent Platform (post-PMF)
- [ ] Автономные агенты + RAG
- [ ] Интеграции с CRM/каналами
