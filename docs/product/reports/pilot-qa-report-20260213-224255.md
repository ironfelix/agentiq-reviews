...
- Generated: 2026-02-13 19:43:25 UTC
...
- [PASS] `sync_review` Sync review: fetched=50 created=0 updated=50
- [PASS] `sync_question` Sync question: fetched=50 created=0 updated=50
...
- [WARN] `open_backlog` (blocker=False): Открытый backlog 344 (целевой <= 250).
- [PASS] `reply_activity` (blocker=False): Ответов через dispatcher в окне: 3.
