...
export function ChatList({ chats, selectedChatId, onSelectChat, onFiltersChange, userName, onLogout, onConnectMarketplace, isConnecting, isLoadingChats, hasApiCredentials, syncStatus, syncError, lastSyncAt }: ChatListProps) {
      ...
      <div className="chat-list-header">
        ...
        <div className="filters-container">
          <div className="filters-scroll">
            ...
            >
              Все <span className="count">{chats.length}</span>
            </button>
            <button
            ...
            {hasApiCredentials ? (
              syncStatus === 'error' ? (
                ...
                <>
                  ...
                  <div className="empty-state-title">Чатов пока нет</div>
                  <div className="empty-state-text">
