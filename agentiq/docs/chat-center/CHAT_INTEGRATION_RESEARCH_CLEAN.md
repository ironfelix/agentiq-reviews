...
Я провел детальное исследование возможности добавления "единого окна чатов" для Ozon, WB и Яндекс.Маркет в платформу AgentIQ. Ниже представлен полный документ, готовый к сохранению в `/Users/ivanilin/Documents/ivanilin/customer-service-ai-product/agentiq/docs/CHAT_INTEGRATION_RESEARCH.md`.
...
**Референс:** WBCON API v2 (см. `/Users/ivanilin/Documents/ivanilin/customer-service-ai-product/agentiq/apps/reviews/backend/tasks.py`)
...
- `/Users/ivanilin/Documents/ivanilin/customer-service-ai-product/agentiq/apps/reviews/backend/tasks.py` — паттерн интеграции с WBCON API v2
- `/Users/ivanilin/Documents/ivanilin/customer-service-ai-product/agentiq/apps/reviews/backend/database.py` — текущая схема БД AgentIQ
- `/Users/ivanilin/Documents/ivanilin/customer-service-ai-product/agentiq/docs/reviews/WBCON_API_V2.md` — документация WBCON API
...
**Путь для сохранения:**
```
/Users/ivanilin/Documents/ivanilin/customer-service-ai-product/agentiq/docs/CHAT_INTEGRATION_RESEARCH.md
```
