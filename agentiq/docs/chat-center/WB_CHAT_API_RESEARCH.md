...
- `/Users/ivanilin/Documents/ivanilin/customer-service-ai-product/agentiq/docs/CHAT_INTEGRATION_RESEARCH_FINAL.md` — сравнение WB, Ozon, Яндекс
- `/Users/ivanilin/Documents/ivanilin/customer-service-ai-product/agentiq/docs/chat-center/OZON_CHAT_API_RESEARCH.md` — референсная документация Ozon
